...
QState bt_SPC51_OPERRATIONAL(bt_SPC51 * const me, QEvt const * const e) {
    QState status_;
    switch (e->sig) {
        //${SMs::bt_SPC51::SM::OPERRATIONAL::sl_bt_evt_gatt_server_characteri~}
...
QMState const bt_SPC51_ADVERTISING_s = {
    ...
    Q_ACTION_CAST(&bt_SPC51_ADVERTISING_x),
    Q_ACTION_NULL  // no initial tran.
};
//${SMs::bt_SPC51::SM::OPERRATIONAL::ADVERTISING}
...
QState bt_SPC51_ADVERTISING_x(bt_SPC51 * const me) {
    ...
    return QM_EXIT(&bt_SPC51_ADVERTISING_s);
}
//${SMs::bt_SPC51::SM::OPERRATIONAL::ADVERTISING}
    ...
    switch (e->sig) {
        ...
        case sl_bt_evt_connection_opened_id: {
            ...
            static struct {
                ...
                {
                    Q_ACTION_CAST(&bt_SPC51_ADVERTISING_x), // exit
                    Q_ACTION_NULL // zero terminator
                }
            };
            status_ = QM_TRAN(&tatbl_);
        ...
        //${SMs::bt_SPC51::SM::OPERRATIONAL::ADVERTISING::sl_bt_evt_sm_bonded_id}
        ...
        //${SMs::bt_SPC51::SM::OPERRATIONAL::ADVERTISING::sl_bt_evt_connection_closed_id}
...
QState bt_SPC51_MANAGING_CONNECTION(bt_SPC51 * const me, QEvt const * const e) {
    QState status_;
    switch (e->sig) {
        //${SMs::bt_SPC51::SM::OPERRATIONAL::MANAGING_CONNECT~::sl_bt_evt_connection_parameters_~}
        case sl_bt_evt_connection_parameters_id: {
            ...
            //${SMs::bt_SPC51::SM::OPERRATIONAL::MANAGING_CONNECT~::sl_bt_evt_connec~::[AtleastConfidetiality]}
            if (event->data.evt_connection_parameters.security_mode == sl_bt_connection_mode1_level1) {
                status_ = QM_HANDLED();
            }
            //${SMs::bt_SPC51::SM::OPERRATIONAL::MANAGING_CONNECT~::sl_bt_evt_connec~::[else]}
            else {
                static struct {
                    QMState const *target;
                    QActionHandler act[2];
